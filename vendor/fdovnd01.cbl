      ...
      *
      * OLD-VENDOR-STATE must be looked up
      *    and must exist in the STATE-FILE
      *    to be valid.
      * OLD-VENDOR-ADDRESS-2 not always used
      *    so may be SPACES
      * OLD-VENDOR-PHONE is usually the
      ...
      ******************************************************************
       ...
       01   OLD-VENDOR-RECORD.
            ...
            05 OLD-VENDOR-CITY                 PIC X(30).
            05 OLD-VENDOR-STATE                PIC X(30).
            05 OLD-VENDOR-ZIP                  PIC X(30).
            05 OLD-VENDOR-CONTACT              PIC X(30).
            05 OLD-VENDOR-PHONE                PIC X(30).
